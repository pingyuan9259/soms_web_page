/* 获取订单售后信息
 * 作者：平原
 * 接口文档：http://wiki.mia.com/pages/viewpage.action?pageId=5379202
 * 2017-12-04 */
...
export default async returnItemId => {
  try {
    if (typeof returnItemId === 'undefined') {
      throw new Error('api: "aftersale/get_info.js" needs param "returnItemId".');
    }

    let res = await Request.get({
      url: `${ API_PREFIX }/v1/customerService/returnOrder/detail/${ returnItemId }`,
    });
